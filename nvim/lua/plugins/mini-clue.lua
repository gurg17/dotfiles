	...
	config = function()
		...
		miniclue.setup({
			...
			clues = {
				...
				-- Explicit global <leader>l keymaps (numbers sort before letters)
				{ mode = 'n', keys = '<Leader>l1', desc = 'LazyGit' },
				{ mode = 'n', keys = '<Leader>l2', desc = 'Lazy (Plugins)' },
				{ mode = 'n', keys = '<Leader>l3', desc = 'Mason (LSP)' },
